...
font-family: 'Titillium Web', sans-serif;">The 17 Goals Admin -- SDG-17</span>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                <ul class="navbar-nav">
                    <li class="nav-link">
                        <a href="../../sdg17/form/17.1.1.php" class="nav-link text-light">Add Data</a>
                    </li>
                    <li class="nav-link">
                        <a href="../../sdg17/edit/edit17.1.1.php" class="nav-link text-light">Update and Delete Data</a>
                    </li>
                    <li class="nav-link">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li><a class="dropdown-item" href="../../sdg3/formsdg3.php">SDG 3</a></li>
                                <li><a class="dropdown-item" href="../../sdg4/formsdg4.php">SDG 4</a></li>
                                <li><a class="dropdown-item" href="../../sdg7/formsdg7.php">SDG 7</a></li>
                                <li><a class="dropdown-item" href="../../sdg8/formsdg8.php">SDG 8</a></li>
                                <li><a class="dropdown-item" href="../../sdg10/formsdg10.php">SDG 10</a></li>
                                <li><a class="dropdown-item" href="../../sdg11/formsdg11.php">SDG 11</a></li>
                                <li><a class="dropdown-item" href="../../sdg14/formsdg14.php">SDG 14</a></li>
                                <li><a class="dropdown-item" href="../../sdg15/formsdg15.php">SDG 15</a></li>
                                <li><a class="dropdown-item" href="../../sdg17/form/17.1.1.php">SDG 17</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
