...
font-family: 'Titillium Web', sans-serif;">The 17 Goals Admin -- SDG-10</span>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                <ul class="navbar-nav">
                    <li class="nav-link">
                        <a href="../../admin/sdg10/formsdg10.php" class="nav-link text-light">Add Data</a>
                    </li>
                    <li class="nav-link">
                        <a href="../../admin/sdg10/up_delsdg10.php" class="nav-link text-light">Update and Delete Data</a>
                    </li>
                    <li class="nav-link">
                        <div class="dropdown">
