...
font-family: 'Titillium Web', sans-serif;">The 17 Goals Admin -- SDG-11</span>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                <ul class="navbar-nav">
                    <li class="nav-link">
                        <a href="../../admin/sdg11/formsdg11.php" class="nav-link text-light">Add Data</a>
                    </li>
                    <li class="nav-link">
                        <a href="../../admin/sdg11/up_delsdg11.php" class="nav-link text-light">Update and Delete Data</a>
                    </li>
                    <li class="nav-link">
                        <div class="dropdown">
