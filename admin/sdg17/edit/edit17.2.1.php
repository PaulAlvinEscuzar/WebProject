            ...
            <table class="table table-striped table-bordered table-hover ">
                <thead class="table-dark text-center">
                    <tr>
                        ...
                        <th scope="col">Total number of campus direct involvement with regional NGOs and government for SDG policy</th>
                        <th scope="col">Title of the policy</th>
                        <th scope="col">Short description (Regional NGO or Government)</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">
                            <a href="../delete/delete17.2.1.php?delete=<?php echo $id ?>"
                                class="btn btn-danger"
                                onclick="return confirm('Are you sure to delete this?')">Delete</a>
                        </td>
                        <td class="text-center">
                            <a href="../update/update17.2.1.php?update=<?php echo $id ?>"
