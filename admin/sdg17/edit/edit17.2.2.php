            ...
            <table class="table table-striped table-bordered table-hover ">
                <thead class="table-dark text-center">
                    <tr>
                        ...
                        <th scope="col">Total number of cross-sectoral SDG dialogue initiated and/or participated</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">
                            <a href="../delete/delete17.2.2.php?delete=<?php echo $id ?>"
                                class="btn btn-danger"
                                onclick="return confirm('Are you sure to delete this?')">Delete</a>
                        </td>
                        <td class="text-center">
                            <a href="../update/update17.2.2.php?update=<?php echo $id ?>"
