...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `17.2.2` (`sdg`, `title`, `description`, `cost`, `source`, `pts`) 
...
<html>
<head>
<title>17.2.2 Cross sectoral dialogue about SDGs</title>
<style>
   .input {
    margin-left: 235px;
    margin-right: 50px;
...
<div class="input">
    ...
    <div class="container mt-5 mb-5">
        <form method="POST" class="flex-grow-1">
            ...
            <h3 class="text-center pb-5">Initiate and participate in cross-sectoral dialogue about the SDGs, e.g. conferences involving government of NGOs</h3>
            <div class="mb-3">
                <input type="text" class="form-control" id="sdg"  name="sdg" placeholder="Total number of cross-sectoral SDG dialogue initiated and/or participated" required>
            </div>
            <div class="mb-3 mt-3">
        ...
        <div class="d-grid">
           <a href="../edit/edit17.2.2.php" class="btn btn-info">Edit Data</a>
            </div>
    </div>
</div>
</body>
