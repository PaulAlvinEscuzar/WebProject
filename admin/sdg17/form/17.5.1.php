...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `17.5.1` (`local`, `title`, `description`, `cost`, `source`, `pts`) 
            VALUES ('$local', '$title', '$description', '$cost', '$source', '$pts')";
...
<html>
<head>
<title>17.5.1 Number of local partnerships</title>
<style>
   .input {
    margin-left: 235px;
    margin-right: 50px;
...
<div class="input">
    ...
    <div class="container mt-5 mb-5">
        <form method="POST" class="flex-grow-1">
            ...
            <h3 class="text-center pb-5">This includes all other local partnerships aside from indicators above that address SDGs</h3>
            <div class="mb-3">
                <input type="text" class="form-control" id="local"  name="local" placeholder="Total number of local partnerships" required>
            </div>
            <div class="mb-3 mt-3">
        ...
        <div class="d-grid">
           <a href="../edit/edit17.5.1.php" class="btn btn-info">Edit Data</a>
            </div>
    </div>
</div>
</body>
