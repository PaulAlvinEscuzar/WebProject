...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `17.2.4` (`sdg`, `title`, `description`, `cost`, `source`, `pts`) 
...
<html>
<head>
<title>17.2.4 Collaboration for SDG best practice</title>
<style>
   .input {
    margin-left: 235px;
    margin-right: 50px;
...
<div class="input">
    ...
    <div class="container mt-5 mb-5">
        <form method="POST" class="flex-grow-1">
            ...
            <h3 class="text-center pb-5">Through international collaboration and research, review comparative
            approaches and develop international best practice on tackling the SDGs</h3>
            <div class="mb-3">
        ...
        <div class="d-grid">
           <a href="../edit/edit17.2.4.php" class="btn btn-info">Edit Data</a>
            </div>
    </div>
</div>
</body>
