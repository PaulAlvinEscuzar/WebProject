...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research7.2.3` SET totnum= '$totnum', titleo = '$titleo',
    ...
    $sql = "SELECT * FROM `research7.2.3` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research714" style="display: block ;">
