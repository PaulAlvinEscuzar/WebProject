...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research7.5.2` SET totnum= '$totnum', percentage='$percentage' WHERE ID = '$id'";
    ...
    $sql = "SELECT * FROM `research7.5.2` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research729" style="display: block ;">
    ...
    <form action="" method="post">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Percentage of the employee population has access to electricity</span>
