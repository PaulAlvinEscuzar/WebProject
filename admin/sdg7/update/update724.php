...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research7.4.2` SET totnumppa = '$totnumppa', title= '$title',
    ...
    $sql = "SELECT * FROM `research7.4.2` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research724" style="display: block ;">
