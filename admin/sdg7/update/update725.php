...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research7.4.3` SET totnum = '$totnum', title= '$title',
    ...
    $sql = "SELECT * FROM `research7.4.3` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research725" style="display: block ;">
