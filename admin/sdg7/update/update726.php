...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research7.4.4` SET totnumppa = '$totnumppa', title= '$title',
    ...
    $sql = "SELECT * FROM `research7.4.4` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research726" style="display: block ;">
    <h2 class="text-center pb-5">Policy development for clean energy technology</h2>
    <form action="" method="post">
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Total number assistance provided in policy development for clean 
energy technology</span>
