...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research11_4_3` SET num_ppa = '$num_ppa', t_ppa = '$t_ppa', short_des = '$short_des', total_cost = '$total_cost' , fund_src = '$fund_src' WHERE ID = '$id'";
    ...
    $sql = "SELECT * FROM `research11_4_3` WHERE ID = '$id'";
...
?>
<div class="collapse w-100 h-auto" id="research1143" style="display: block ;">  
    <h2 class="text-center pb-5">Allow remote working</h2>
    <form action="" method="post">
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Total number of PPAs that allow remote working:</span>
