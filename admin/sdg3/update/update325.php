...
if (isset($_GET['update'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE `research3.2.5` SET 
        sexActive = '$sexActive',
        pregnant = '$pregnant',
        haveBirth = '$haveBirth',
    ...
    $sql = "SELECT * FROM `research3.2.5` WHERE ID = '$id'";
    ...
    if (mysqli_num_rows($select) > 0) {
        while ($row = mysqli_fetch_assoc($select)) {
            ...
            $fund = $row['fund'];
?>
<div class=" w-100 h-auto p-3" id="research324" style="display: block ;">
<h2 class="text-center pb-4 mt-5">Sexual and reproductive health care services for employees</h2>
    ...
    <form action="" method="post">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Total number of employees that are sexually active:"
        ...
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control" placeholder="Total number of employees have already given birth"
                name="haveBirth" value="<?php echo $haveBirth ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control" placeholder="Total number of employees with pregnancy loss"
                name="pregnantLoss" value="<?php echo $pregnantLoss ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class="bi bi-envelope"></i></span>
            <input type="text" class="form-control" placeholder="Total number of employees who have impregnated someone"
                name="impregnated" value="<?php echo $impregnated ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total number of employees that has been tested for HIV/AIDS" name="testHIV"
                value="<?php echo $testHIV ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the employee'spopulation is sexually active. " name="percentSexActive"
                value="<?php echo $percentSexActive ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the female employee'spopulation is currently pregnant. "
                name="percentfPregnant" value="<?php echo $percentfPregnant ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the female employee'spopulation have already given birth"
                name="percentfBirth" value="<?php echo $percentfBirth ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the female employee'spopulation have experienced pregnancy loss."
                name="percentfPregLoss" value="<?php echo $percentfPregLoss ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the male employee'spopulation have impregnated someone"
                name="percentmImpreg" value="<?php echo $percentmImpreg ?>">
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder="Total percent of the male/female employee'spopulation have been tested for HIV/AIDS. "
                name="percenttestHIV" value="<?php echo $percenttestHIV ?>">
        </div>
        <div class="input-group mb-5">
            <span class="input-group-text"><i class=""></i></span>
            <input type="text" class="form-control"
                placeholder=" Total number of sexual and reproductive health-care services for employees"
